...
- A Dockerfile for a vulnerable build and a multi-stage version of that
...
The matching Kyverno `ClusterPolicy` from the talk pins on:
...
`ghcr.io/ronaldharmsen/devsum2026:latest` (public)

## Verifying manually

```sh
cosign verify \
  --certificate-identity 'https://github.com/ronaldharmsen/devsum2026/.github/workflows/build-and-sign.yml@refs/heads/main' \
  --certificate-oidc-issuer 'https://token.actions.githubusercontent.com' \
  ghcr.io/ronaldharmsen/devsum2026:latest
```
